...
import (
	...
	"github.com/omegasuite/omgwallet/internal/legacy/keystore"
...
type config struct {
	...
	OmcdUsername     string                  `long:"btcdusername" description:"Username for btcd authentication"`
	OmcdPassword     string                  `long:"btcdpassword" default-mask:"-" description:"Password for btcd authentication"`
...
func loadConfig() (*config, []string, error) {
	...
	if cfg.OmcdUsername == "" {
		cfg.OmcdUsername = cfg.Username
	}
	if cfg.OmcdPassword == "" {
		cfg.OmcdPassword = cfg.Password
	}
