...
//
//   https://github.com/omegasuite/omgwallet/blob/master/rpc/documentation/api.md
//
// Any API changes must be performed according to the steps listed here:
//
//   https://github.com/omegasuite/omgwallet/blob/master/rpc/documentation/serverchanges.md
package rpcserver
...
import (
	...
	"github.com/omegasuite/omgwallet/internal/cfgutil"
	"github.com/omegasuite/omgwallet/internal/zero"
	"github.com/omegasuite/omgwallet/netparams"
	pb "github.com/omegasuite/omgwallet/rpc/walletrpc"
	...
	*pb.FundTransactionResponse, error) {
	...
	for _, output := range unspentOutputs {
		...
		selectedOutputs = append(selectedOutputs, &pb.FundTransactionResponse_PreviousOutput{
			...
			Amount:          output.Output.Value.(*token.NumToken).Val,
		...
		totalAmount += btcutil.Amount(output.Output.Value.(*token.NumToken).Val)
